...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div id="printArea" class="node-content-wrapper clearfix">
    ...
    <?php
      ...
      if ($used_loc == 'cebu') {
        echo"<script>(function(e,t,c,n){var s,o,a;e.SMCX=e.SMCX||[],t.getElementById(n)||(s=t.getElementsByTagName(c),o=s[s.length-1],a=t.createElement(c),a.type='text/javascript',a.async=!0,a.id=n,a.src=['https:'===location.protocol?'https://':'http://','widget.surveymonkey.com/collect/website/js/Dx_2B6nJIx0Xj5IQflNpINfCgJ1LYIEL_2FWM8emUEBCcBsVcqhhbCu5jfyS2AfaDjNL.js'].join(''),o.parentNode.insertBefore(a,o))})(window,document,'script','smcx-sdk');</script>";
      }
